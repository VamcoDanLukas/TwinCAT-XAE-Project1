...
class CMyCppProjectCtrl : public ITcOCFCtrlImpl<CMyCppProjectCtrl, CMyCppProjectClassFactory>
{
public:
	CMyCppProjectCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("MyCppProject: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CMyCppProjectCtrl>;
